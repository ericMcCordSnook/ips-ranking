...
def main():
    ...
    NUM_SIM_RANKINGS = 1000
    BASE_LIST = [i for i in range(1, NUM_RANKING_ELEMENTS+1)]

    # GROUND_TRUTHS = np.array([[1,2,3,4],[1,2,4,3],[2,1,4,3],[2,1,3,4],[4,3,2,1],[4,1,2,3]])
    ...
    all_rankings_data = generate_simulated_ranks(BASE_LIST, NUM_RANKING_ELEMENTS, 
        WEIGHT_A, WEIGHT_B, NUM_SIM_RANKINGS, data_summary=False, ground_truth=np.array(BASE_LIST))
    ...
    # DATASETS = ["soccerPL", "soccerUEFA", "sports"]
